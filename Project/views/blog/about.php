				...
				<div class="row">
					<div class="col-md-8">
						<div class="section-row">
							<h4>Xin chào!</h4>
							<p>Chào mừng các bạn đến với trang Nam Blog :)))</p>
							<p>Ở đây các bạn có thể chia sẽ các bài viết mà các bạn thích!</p>
							<p>Cảm ơn các bạn đã đến với chúng tôi.</p>
						</div>
						<div class="row section-row">
							<h4>Liên hệ với chúng tôi</h4><span><a href="?mod=blog&act=contact">tại đây</a></span>
						</div>
					</div>
