                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Bảng Thêm</strong> Bài Viết
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="?mod=post&act=store" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="col col-md-9">
                                                    <div class="form-check-inline form-check">
                                                        <label for="inline-checkbox1" class="form-check-label ">
                                                            <input type="checkbox" id="inline-checkbox1" name="status" value="1" class="form-check-input">Kích hoạt
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
