...
<body class="animsition">
    <div class="page-wrapper">
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="?mod=home">
                            <img src="public/images/icon/logo1.png" alt="CoolAdmin" />
                        </a>
                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="?mod=login&act=login">Đăng nhập</a>
                                </li>
                                <li>
                                    <a href="http://localhost/hoctap/PHP24/Project/?mod=blog">Blog</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="?mod=home">
                    <img src="public/images/icon/logo1.png" alt="Cool Admin" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#"><?= $_SESSION['author']['name'] ?></a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#"><?= $_SESSION['author']['name'] ?></a>
                                                    </h5>
                                                    <span class="email"><?= $_SESSION['author']['email'] ?></span>
                                                </div>
                                            </div>
                                            <?php if ($_SESSION['author']['user'] != 1) { ?>
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="?mod=authoruser&act=edit&id=<?= $_SESSION['author']['id'] ?>">
